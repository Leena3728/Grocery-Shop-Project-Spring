...
function addOrder()
{
    ...
    var customerId=parseInt(sessionStorage.getItem("customerId"));
     $.ajax({
    url: 'http://localhost:8080/api/grocery/v1/addorder',
    dataType: 'json',
    type: 'post',
...
function addTransaction()
{
      ...
      $('input[id="cash-on-delivery"]:checked')
    {
      transactionMode="Offline - Cash On Delivery";
     	 ...
     	 $.ajax({
    url: 'http://localhost:8080/api/grocery/v1/addtransaction',
    dataType: 'json',
    type: 'post',
    contentType: 'application/json',
    data: JSON.stringify(  
...
function addDelivery()
{
	...
	$.ajax({
    url: 'http://localhost:8080/api/grocery/v1/adddelivery',
    dataType: 'json',
    type: 'post',
    contentType: 'application/json',
    data: JSON.stringify(
...
if(localStorage.length>1)
  ...
  { //alert('inside');
   ...
   //alert(product.productName+" "+product.productPrice+" "+product.productQuantity+" "+orderId);
    $.ajax({
    url: 'http://localhost:8080/api/grocery/v1/addorderedproducts',
    dataType: 'json',
    type: 'post',
    contentType: 'application/json',
    data: JSON.stringify(  
